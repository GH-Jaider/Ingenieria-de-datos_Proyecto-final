...
Las sentencias SQL para realizar la carga de datos se encuentran en la carpeta ‘Entrega2’ como: *DML_lol.sql* Se aprovecharon las funciones de carga masciva de datos de la siguiente manera:
~~~
